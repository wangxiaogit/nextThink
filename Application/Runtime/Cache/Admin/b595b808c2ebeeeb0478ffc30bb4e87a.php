...
<link href="/nexTthink1/Public/Admin/img/favicon.ico" type="image/x-icon" rel="shortcut icon">
        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                <a href="<?php echo U('index/index');?>" class="brand"> 
                    <small> 
                        <img src="/nexTthink1/Public/Admin/img/logo-18.png">
...
<!--                            <?php if(sp_auth_check(get_current_admin_id(),'admin/setting/site')): ?><li><a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','<?php echo L('ADMIN_SETTING_SITE');?>');"><i class="fa fa-cog"></i> <?php echo L('ADMIN_SETTING_SITE');?></a></li><?php endif; ?>
    ...
    <script src="/nexTthink1/Public/Admin/js/index.js"></script>
</body>
</html>